...
class OverlayCoordinator {
    ...
    weak var activeWindow: NSWindow?
    weak var cursorWindow: NSWindow?
    var firstMoveReceived = false
    var launchTime: CFAbsoluteTime = 0
    let minExpandedDuration: TimeInterval = 3
    var inactivityTimer: Timer?
    let inactivityTimeout: TimeInterval = 600 // 10 minutes
    ...
    func createWindow(for screen: NSScreen, image: CGImage?, isCursorScreen: Bool, hideHintBar: Bool) -> NSWindow {
    ...
    func wireCallbacks(for window: NSWindow) {
