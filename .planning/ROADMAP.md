...
- [x] Phase 11: Hint Bar + Multi-Monitor + Polish (6 plans) (completed 2026-02-16)
  ...
  - [x] 11-03-PLAN.md — Gap closure: multi-monitor fixes (black screen, preview line freeze, color circle position)
  - [x] 11-04-PLAN.md — Gap closure: color circle borders/animation + hint bar keycap symbols
  - [ ] 11-05-PLAN.md — Gap closure: coordinate conversion for second monitor screenshot
  - [ ] 11-06-PLAN.md — Gap closure: color circle position on all windows + keycap refinements
