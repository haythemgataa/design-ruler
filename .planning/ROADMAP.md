...
- [ ] Phase 11: Hint Bar + Multi-Monitor + Polish (2 plans)
  - [ ] 11-01-PLAN.md — Polish fixes (remove state, pill opacity, circle borders/colors) + hint bar content infrastructure
  - [ ] 11-02-PLAN.md — Multi-monitor window setup + hint bar integration + remove-state fix wiring
...
| 10. Remove Interaction + Color System | v1.2 | Complete    | 2026-02-16 | — |
| 11. Hint Bar + Multi-Monitor + Polish | v1.2 | 0/2 | ◻ Planned | — |
